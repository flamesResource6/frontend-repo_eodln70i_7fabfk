        ...
        <div className="max-w-7xl mx-auto px-4 pt-28 pb-20">
          <div className={`grid md:grid-cols-2 gap-10 items-center ${rtl ? 'text-right' : 'text-left'}`}>
            <div>
              ...
              <p className="mt-4 text-gray-700 text-base md:text-lg">{t.description}</p>
              ...
              <ul className={`mt-6 space-y-2 ${rtl ? 'list-none' : 'list-none'}`}>
                {t.checklist.map((c, i) => (
                  <li key={i} className="flex items-start gap-3 text-gray-800">
                    <div className="mt-1 w-5 h-5 rounded-full bg-green-500 text-white flex items-center justify-center"><Check className="w-3 h-3"/></div>
